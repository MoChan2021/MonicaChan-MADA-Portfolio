...
![Original Graphic](https://github.com/MoChan2021/MonicaChan-MADA-portfolio/blob/352d0a75e228fed5cbfecfbc5887d6f2b7b614b7/docs/OrigViz.png?raw=TRUE⁩)
...
I enjoyed learning about annotating. I knew there was the capibilities but never tried using it. I've got a bit of ways to go when it comes to really cleaning up the graphcis but I also got to learn about how to utilize dates in ggplot. This will be useful in helping some of my peers when they do persistance studies and can utlize their summarized experimental run data to plug into something.
