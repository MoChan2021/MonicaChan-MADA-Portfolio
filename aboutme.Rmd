...
![About Me](./Photos/AboutMe.jpg)

### **Background & Training**
I've been around for a bit trying a bit of this and that. If I complete this final go around with education that would make me a _triple dawg_.. 
...
* **M.S.**: _Environmental Health_ (SMITH, LIPP, & LU)  
  - _Prevalence of _Cronobacter sakazakii_ in domestic environments in GA_.
  - Food science, Quality Control, Pregnancy Health, Developmental Tox.
* **Fellowship**: _ORISE Fellow_   
  - Built-environment (healthcare), composite sample approaches & swab-to-sequencer workflow development and validation.
* **Ph.D.** _(student)_: _Environmental Health_ (GLENN, LIPP, OTTESEN, & SANCHEZ)  
  - Environmental Sample enhancement techniques for integration into swab-to-sequencer methods (MinION sequencing)
* **Federal Agency**: _Microbiologist_
  - All of the previous and whatever the Agency's needs are. (COVID Response)
  - Specializing in recovery tool evaluation.
  - Evaluating and standardizing new tools and processes for guidance in  field sampling and sample preservation.


### **Research Interests**

* Improving/standardizing environmental sampling methods. 
...
![Sponge Stick Me](./Photos/SpongeMe.jpg)
